...
import sys
import argparse
from fst_builder import build_hindi_fsl, is_valid_word
...
def main():
    ...
    parser.add_argument("input_text", nargs="*", help="Hindi word or sentence to analyze")
    ...
    if args.input_text:
        ...
        print("Hindi FSL Interactive Mode. Type a word or sentence (or 'q' to quit):", file=sys.stderr)
        while True:
            try:
