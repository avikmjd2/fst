"""
Bengali FSL Test Evaluator
Evaluates the morphological analyzer against a CoNLL-U format test file.
"""

import sys
import argparse
from fst_builder import build_bengali_fsl
from analyzer import generate_conllu_line

def main():
    parser = argparse.ArgumentParser(description="Evaluate Bengali FSL against test data")
    import os
    ...
    print("Initializing Bengali FSL...")
    # build_bengali_fsl() isn't strictly used for the heuristics but let's init it
